	function viewlegBallBoard(root,sportCode,currentPage){
		...
		$.ajax({
			...
			success:function(data){
				...
				var list = data.legBallBoardList;
		  ...
		  $("#modallegBallBoard").toggle();
		   ...
		   $.ajax({
			   ...
			   success:function(data){
				   ...
				   $("#legBallBoardTitle").attr('value',board.boardTitle);
				   $("#legBallBoardContent").text(board.boardContent);
			   }
		   });
	}
	...
	function modalToggle(){
	   ...
	   function showAgeChart(root,sportCode){
		   ...
		   $.ajax({
			  ...
			  url:addr,
			  success:function(data){
				  $("#legBallLineChart").hide();
				  $("#legBallBarChart").hide();
				  $("#legBallPieChart").show();
				  ...
				  $.jqplot('legBallPieChart',[[['10대',first],['20대' , second] , ['30대' , third] , ['40대' , fourth] , ['50대' , fifth] , ['기타' , others]]],
							{  
	 					seriesDefaults:{
	   ...
	   function showCityChart(root,sportCode){
		   ...
		   $.ajax({
			  ...
			  success:function(data){
				  console.log(data);
				  $("#legBallPieChart").hide();
				  $("#legBallLineChart").hide();
				  $("#legBallBarChart").show();
				  ...
				  $.jqplot('legBallBarChart',[[['서울',first],['경기' , second] , ['강원' , third] , ['충청도' , fourth] , ['경상도' , fifth] , ['전라도' , sixth],['기타',others]]],
						  {
		   				title:'지역별 통계',
	   ...
	   function showDayChart(root,sportCode){
		   ...
		   $.ajax({
			  ...
			  success:function(data){
				...
				$("#legBallPieChart").hide();
				$("#legBallBarChart").hide();
				$("#legBallLineChart").show();
				 $.jqplot('legBallLineChart',[[spring,summer,fall,winter]],
				  			{
							title:'연령별 통계',
							axes:{
								xaxis:{
	   ...
	   function showLeagueInfo(root,sportCode){
		   var addr = root+"/showLeaguelegBallInfo?sportCode="+sportCode;
	   ...
	   function leagueTable(root , sportCode,teamName){
		   var addr = root +"/legBallleagueTable?sportCode="+sportCode;
		   $("#leagueTable").empty();
		   //alert(teamName);
		   $.ajax({
			  type:"GET",
	   ...
	   */
	   ...
	   function showRecentMatch(root,sportCode){
		   var addr = root+'/legBallshowRecentMatch?sportCode='+sportCode;
