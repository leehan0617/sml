...
<div style="background-image:url('${root}/resources/images/soccer_background.jpg')" class="background">
	...
	<br/><br/>	
	<div id="matchingList" class="container" align="center">
			<div class="row">
				<div class="col-sm-6">
						<h3><a href="">금주매치</a></h3>
						<div>
	...
	<div class="container" align="center">
		<div class="row">
			<div class="col-sm-6">
				...
				<div class="container" align="center">
					<a href="${root}/static/chart.do?legion=legion"><Strong>지역별 통계</Strong></a>
					<a href="${root}/static/chart.do?age=age"><Strong>연령별 통계</Strong></a>
				</div>
			</div>	
	</div>				
