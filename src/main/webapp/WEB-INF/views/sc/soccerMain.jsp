          ...
          <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
              	<li><a href="${root}/soccer/soccerCommonBoardPage.do?sportCode=${sportCode}" style="color:white;">공지사항</a></li>
                <li><a href="${root}/soccer/soccerRule.do?sportCode=${sportCode}" style="color:white;">경기규칙</a></li>
                <li><a href="${root}/soccer/soccerTeamList.do?sportCode=${sportCode}" style="color:white;">팀리스트</a></li>
