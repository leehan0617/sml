...
<html lang="ko">
	...
	<script src="${root }/resources/js/legBallPage.js"></script>
    ...
    <link href="${root}/resources/css/legBallPage.css" rel="stylesheet" type="text/css">
    <style>
    .ui-autocomplete { 
    overflow-y: scroll; 
    overflow-x: hidden;}
...
<!-- NAVBAR ================================================== -->
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette" id="chartMain">
        ...
        <div class="col-md-5">
          ...
          <div id="legBallPieChart" data-holder-rendered="true" style="width:460px; height:400px;"></div>
          <div id="legBallLineChart" data-holder-rendered="true" style="width:460px; height:400px;"></div>
          <div id="legBallBarChart" data-holder-rendered="true" style="width:460px; height:400px;"></div>
        </div>
      </div>
    ...
    <div class="modal fade" id="modallegBallBoard" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   ...
   <div class="modal fade" id="modallegBallBoardRead" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
 	 <div class="modal-dialog">
    	<div class="modal-content">
    		<div class="modal-header">
    			<h3>공지사항</h3>
    		...
    		<div class="modal-body">
    			 <div class="form-group">
           			 ...
           			 <input type="text" class="form-control" id="legBallBoardTitle" value="" disabled="disabled"/>
        		  </div>
         		 <div class="form-group">
           			 <label for="message-text" class="control-label" id="boardContent">Content</label>
           			 <textarea class="form-control" id="legBallBoardContent" disabled="disabled"></textarea>
        		  </div>
    		</div>
      		<div class="modal-footer">
   ...
   <div class="modal fade" id="modallegBallChart" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   	<div class="modal-dialog">
    	<div class="modal-content">
    		<div class="modal-header">
    			<h3>통계자료</h3>
