...
<div class="row replyList">	
  				<c:forEach var="teamLog" items="${replyList}" begin="0" varStatus="status" end="4">
					...
					<div class="col-md-6 ${teamLog.replyCode }" style="margin-top:5px;">
						<div class="input-group">
					     ...
					     <span class="input-group-btn">
					       	<button class="btn btn-danger" type="button" onclick="deleteReply('${root}','${teamLog.teamCode }' , '${teamLog.replyCode}')">삭제</button>
					     </span>
						</div>
					</div>
				</c:forEach>
			...
			<div class="alert alert-warning" role="alert" onclick="moreReadReply('${root}','${teamCode }' , '${replyPageNumber }')" style="margin-top:5px;"><p class="text-center">더보기</p></div>