						...
						<tbody>	
							<c:forEach var="manageLeagueList" items="${manageLeagueList}">
								<tr>
									...
									<td><img src="${root }/img/leagueImg/${manageLeagueList.leagueImage}"></td>	
									...
									<c:if test="${manageLeagueList.leagueState==-1 }">
										<td><input type="button" value="게시하기" onclick="location.href='${root}/admin/leagueSwitch.do?pageNumber=${currentPage }&leagueCode=${manageLeagueList.leagueCode }&leagueState=${manageLeagueList.leagueState}'"/></td>
									</c:if>
									
									<c:if test="${manageLeagueList.leagueState== 1 }">
										<td><input type="button" value="게시하지 않기" onclick="location.href='${root}/admin/leagueSwitch.do?pageNumber=${currentPage }&leagueCode=${manageLeagueList.leagueCode }&leagueState=${manageLeagueList.leagueState}'"/></td>
									</c:if>
									<td><a href="${root }/admin/leagueDelete.do?leagueCode=${manageLeagueList.leagueCode}">[삭제]</a></td>	
								</tr>
							</c:forEach>
						</tbody>
					</table>
