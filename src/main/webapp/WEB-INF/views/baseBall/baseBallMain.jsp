  ...
  <body>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                  	<li class="divider"></li>
                    <li><a href="${root}/scMain">야구</a></li>
                    <li class="divider"></li>
                    <li><a href="${root}/baseBall/baseBallMain.do">야구</a></li>
                    <li class="divider"></li>
                    <li><a href="#">족구</a></li>
                    <li class="divider"></li>
                    <li><a href="${root }/scMain">농구</a></li>
                    <li class="divider"></li>
                  </ul>
                </li>
                <li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item">
          <img class="first-slide" src="${root }/resources/images/baseBallMain1.png" alt="First slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>WELCOME SML SOCCER PAGE </h1>
              <p>이 페이지에는 야구에 관련된 리그 및 팀들간 정보가 있습니다.</p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Default Button</a></p>
            </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="${root }/resources/images/baseBallMain2.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>공지사항</h1>
              <p>야구에 관련된 실시간 소식 및 정보를 여기서 확인해주세요.</p>
        ...
        <div class="item active">
          <img class="third-slide" src="${root}/resources/images/baseBallMain3.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>다른종목이 궁금하세요?</h1>
              <p>SML KOREA는 야구이외에도 야구,족구,농구에 관한 친선및리그경기 매칭서비스를 제공하고있습니다.</p>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          <h2>통계 자료</h2>
          <p>SML 야구회원 및 팀들간 통계에 관심이 있으시면 아래 버튼을 눌러주세요</p>
      ...
      <div class="row featurette" id="chartMain">
        <div class="col-md-7">
          ...
          <p class="lead">여기는 SML 야구 이용자들의 각종 통계 및 차트를 보여주는 곳입니다. 차트와 자신의 정보를 비교해보세요. 이용자들이 많을 수록 통계는 더 정확한 정보를 보여줍니다.</p>
       	  <br/>
       	  <br/>
        </div>
        <div class="col-md-5">
